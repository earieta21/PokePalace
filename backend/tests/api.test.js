...
// dentro del horario de cualquier día (el más corto es 11-21, y el
// restaurante ya abre los 7 días), sin importar a qué hora corra el CI.
function tomorrowAt15() {
  const key = nextDateKey(dateKeyInTimeZone());
